...
const LoginPage = () => {
  ...
  return (
    <main className="max-md:h-dvh md:h-screen w-full flex flex-col gap-10 p-5 justify-center items-center">
      ...
      <form
        ...
        className="max-w-110 w-full max-h-122.75 h-full box"
      >
        {!animate ? (
          <div className="h-fit w-full flex flex-col gap-5">
            ...
            <div className="flex gap-2 bg-[#EFF4F9] p-4">
              ...
              <p className="text-sm text-[#43474E]">
                You are logging into a proctored session. IP tracking and
                browser monitoring are active.
              </p>
            </div>
